...
skip_ext_list = ["zip", "jal", "pdf", "bin", "css", "class", "dat", "dot","hwp",
"psd", "mp4", "avi", "swf", "mpg", "mov", "avi", "mov", "vob", "ai",
"zip", "alz", "dll", "bin", "exe", "apk",
"wav", "mp3", "wma", "asf", "asx", "fl3", "m4p", "caf", "ra", "wax", "movie", "mp4",
"jpg", "jpge", "png", "gif", "psd", "jpeg", "pic", "bmp", "tif", "ico", "psp", "ai", "eps", "fla",
"acl","ade","asd","cnv","crtx","doc","docm","docx","dot","dotm","dotx","grv","h1q","iaf",
